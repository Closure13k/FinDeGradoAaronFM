...
public class ClienteController {
    ...
    /**
     * Actualiza la lista de clientes a usar y luego filtra dentro de la propia lista.
     ...
     * una serie de utilidades (.orElse, .orElseThrow, .map, etc.) para gestionar
     * el objeto. Asegura los null-checks.
     */
     ...
     * <br>
     * Una vez se añade el cliente, se recupera el ID que generó su clave auto incremental.
     * Se actualiza el objeto que se pasó para que muestre dicha clave.
     * @param cliente
    ...
    /**
     * Para evitar repetir código en el insert y update.
     * Ambos usan los cinco campos para sus set/insert.
     * <br>
     * @see ClienteEntity#insertQuery()
     * @param ps El prepared sobre el que se trabaja.
     * @param cliente
     * @throws SQLException Si hubiera algún fallo mientras se procesa el prepared.
     */
